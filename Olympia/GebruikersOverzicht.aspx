                                ...
                                <td colspan="2">
                                    <asp:DataGrid ID="dtgDataGrid" RowHighlightColor="#cccccc" RowClickColor="#ebe0fb"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateColumn HeaderStyle-CssClass="datagridHeaderNonSort" ItemStyle-HorizontalAlign="Center" SortExpression="bedrag" HeaderStyle-Width="60" HeaderText="Bedrag">
                                                <ItemTemplate>
                                                ...
                                                <asp:TemplateColumn HeaderStyle-CssClass="datagridHeaderNonSort" ItemStyle-HorizontalAlign="Center" SortExpression="Validate" HeaderStyle-Width="60" HeaderText="OK">
                                                <ItemTemplate>
