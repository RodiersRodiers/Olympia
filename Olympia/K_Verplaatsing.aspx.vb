...
Partial Class K_Verplaatsing
    ...
    Private Sub LoadData()
        Try
            Dim myList As List(Of Handelingen) = myBalOlympia.gethandelingbygebruiker(getDefaultSortExpressionLabel1, cbopsteller.SelectedValue, Vergoedingen.Verplaatsingen)
