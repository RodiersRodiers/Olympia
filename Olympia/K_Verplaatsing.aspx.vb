...
Partial Class K_Verplaatsing
    ...
    Private Sub ValidateToegang()
        Dim i As Integer
        i = myBalOlympia.CheckToegangGebruiker(Session("Gebruiker"), 13) 'Verplaatsingen
        Select Case i
            ...
            Case Else
                ...
                mylogging.EventLogging = "Vergoeding Verplaatsingen toegang geweigerd (Domein: 13) "
    ...
    Private Sub fillUpStringFields() 'Fill up the strings
        ...
        lblPageTitle.Text = "Verplaatsingen"
    ...
    Private Sub LoadData(ByVal strfilter As String)
        Try
            Dim myList As List(Of Handelingen) = myBalOlympia.GethandelingVerplaatsingbygebruiker(getDefaultSortExpression, cbopsteller.SelectedValue, strfilter)
        ...
        Try
            ...
            Select Case e.CommandName
                Case "INSERT"
                    ...
                    myhandeling.Actie.Id = Vergoedingen.Verplaatsingen
                    ...
                    Try
                        ...
                        If i_Result > 0 Then
                            ...
                            Dim mylogging As New Logging
                            mylogging.Gebruiker.IdLid = Session("Gebruiker")
                            mylogging.EventLogging = "Insert Vergoeding Verplaatsing - " & txtInsertDatum.Text & ": " & txtInsertInfo.InnerText
                            mylogging.Type = 2
                            myBalOlympia.InsertLogging(mylogging)
                            LoadData(txtfilter.Text)
                        End If
                ...
                Case "DELETE"
                    ...
                    myhandeling.Datum = lblDatum.Text
                    myhandeling.Info = lblInfo.Text
                    Try
                        ...
                        If i_Result > 0 Then
                            ...
                            Dim mylogging As New Logging
                            mylogging.Gebruiker.IdLid = Session("Gebruiker")
                            mylogging.EventLogging = "Delete Vergoeding Verplaatsing - " & lblDatum.Text & ": " & lblInfo.Text
                            mylogging.Type = 2
                            myBalOlympia.InsertLogging(mylogging)
                            LoadData(txtfilter.Text)
                        End If
                ...
                Case "UPDATE"
                    ...
                    Try
                        ...
                        If i_Result > 0 Then
                            ...
                            Dim mylogging As New Logging
                            mylogging.Gebruiker.IdLid = Session("Gebruiker")
                            mylogging.EventLogging = "Update Vergoeding Verplaatsing - " & txteditDatum.Text & ": " & txteditinfo.InnerText
                            mylogging.Type = 2
                            myBalOlympia.InsertLogging(mylogging)
                        End If
                    Catch ex As Exception
